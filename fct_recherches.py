...
def rechercher_type() :
    while True :
        type_input = input(colorama.Fore.YELLOW + "Entrez le type recherché (livre ou article) : " + colorama.Style.RESET_ALL)
        if type_input.lower() == "livre" :
            ...
            print(colorama.Fore.RED + "Veuillez reformuler votre demande - en inscrivant livre ou article" + colorama.Style.RESET_ALL)
    return type 
